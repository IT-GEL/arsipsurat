...
class DashboardMSSController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'namaPT' => 'nullable|string',
            'pelabuhanTujuan' => 'nullable|string',
            'vessel' => 'nullable|string',
            'btb' => 'nullable|string',
            'tglPengapalan' => 'nullable|date',
            'pelabuhanMuat' => 'nullable|string',
            'namaPenerima' => 'nullable|string',
            'saranaAngkutan' => 'nullable|string',
            'tonase' => 'nullable|string',
            'tglPemuatan' => 'nullable|date',
