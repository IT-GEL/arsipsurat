                ...
                <div class="bg-light rounded h-100 p-4 mx-auto" style="width: 210mm;">
                    ...
                    <form method="post" action="/dashboard/prc/{{ $prc->id }}">
                        ...
                        <div class="mb-3">
                            ...
                            <span
                                style="font-weight:bold;">{{ $prc->prefix }}</span>
                            <input type="hidden" id="noSurat" name="noSurat" value="{{ old('noSurat', $prc->noSurat) }}"
                        ...
                        <div id="keterangan-field" class="mb-3">
                            ...
                            <input type="hidden" id="keterangan" name="keterangan"
                                value="{{ old('keterangan', $prc->keterangan) }}">
                            <script>
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="date" class="form-control @error('tglSurat') is-invalid @enderror"
                                id="tglSurat" name="tglSurat" required value="{{ old('tglSurat', $prc->tglSurat) }}"
                                readonly>
                            @error('tglSurat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ttd') is-invalid @enderror" id="ttd"
                                name="ttd" required value="{{ old('ttd', $prc->ttd) }}" readonly>
                            @error('ttd')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
