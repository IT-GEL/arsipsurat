...
<html lang="en">
  ...
  <head>
    ...
    body {
        ...
        background-image: url('{{ asset('img/' . $prc->kop . '-kop.png') }}');
  ...
  @if ( $prc->kop  == "QIN")
                        ...
                        <table width="545">
                            ...
                            <td width="10">:</td>
                            <td width="335">{{ $prc->qty }} (+/- 10%) for two barge</td>
                            </tr>
                        </table>
                        <table width="545">
                            <td width="20"> 7. </td>
                        ...
                        <table width="545">
                            ...
                            <td width="10">:</td>
                            <td width="335">CIF {{ $prc->cif }}</td>
                        <table width="545">
                            <td width="200"></td>
                            <td width="35"></td>
                            <td width="335">FOB {{ $prc->fob }}</td>
                        </table>
                        <table width="545">
                            <td width="200"> </td>
                            <td width="35"></td>
                            <td width="335">FREIGHT {{ $prc->freight }}</td>
                        </table>
                            </tr>
                        </table>
                        <table width="545">
                            ...
                            <td width="10">:</td>
                            <td width="335">{{ $prc->shipschedule }}</td>
                            </tr>
                        </table>
                        <table width="545">
                            <td width="20">11. </td>
                        ...
                        <table width="545" >
                            <tr>
                            <td width="335" class="table-keterangan">{!! $prc->qas !!}</td>
                            </tr>
                        </table>
                        <br>
                        <table width="545">
                        ...
                        <table width="545" style="font-weight:bold;">
                            <tr>
                            <td><img style="height:50px; weigth:50px;padding-left:45px;" src="{{ asset('img/qrcodes/' . $prc->qr ) }}" alt="QR Code"></td>
                            </tr>
                        </table>
                        <br><br><br>
                        <table width="545" style="font-weight:bold;">
...
@endif
  ...
  <br><br><br>
                        <table width="545">
                            <tr>
                                <td style="text-align: right">Jakarta, {{ formatDateIndonesian($prc->tglSurat) }}</td>
                            </tr>
                        </table>
                        <br><br>
                        <table width="545">
                        ...
                        <table width="545">
                            ...
                            <td style="font-family: 'Times New Roman', Times, serif; font-size: 18px; text-align: center; font-weight: bold; text-transform:uppercase" class="text">
                                <u>{{ $prc->perihal }} {{ $prc->ptkunjungan }}</u>
                            </td>
                            </tr>
                            <tr>
                            <td style="text-align: center; font-weight: bold; font-style: italic;">{{ $prc->prefix }}</td>
                            </tr>
                        </table>
                        <br>
                        <table width="545">
                            ...
                            <tr>
                            <td>Kami PT. Global Energi Lestari (GEL) sebagai pemilik tambang batubara. Menindaklanjuti pengajuan permintaan kunjungan yang akan dilakukan oleh {{ $prc->pttujuan }} di tambang {{ $prc->ptkunjungan }} pada tanggal {{ $prc->tglSurat }}. Berikut nama yang akan melakukan kunjungan:</td>
                            </tr>
                        </table>
                        <br><br>
