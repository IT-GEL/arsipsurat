    ...
    <div class="row g-4">
        <div class="col-sm-6 col-xl-5">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                ...
                <div class="ms-3">
                    <p class="mb-2">Total Surat Keterangan Global Sinergi Maritim</p>
...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light text-center rounded p-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h6 class="mb-0">Daftar Surat Divisi Global Sinergi Maritim</h6>
            <a href="{{ url('/dashboard/gsm/create') }}" class="btn btn-primary"><i class="bi bi-file-text-fill"></i> Tambah Surat</a>
        </div>
            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary" href="{{ url('/dashboard/gsm/' . $item->id) }}"><i class="bi bi-info-square"></i></a>
                            <a class="btn btn-sm btn-warning" href="{{ url('/dashboard/gsm/' . $item->id . '/edit') }}" @if($item->approve == "1") style="pointer-events:none; opacity:0.5;" @endif><i class="bi bi-pencil-square"></i></a>
                            <form action="{{ url('/dashboard/gsm/' . $item->id) }}" method="post" class="d-inline delete-form">
                                @method('delete')
                                @csrf
