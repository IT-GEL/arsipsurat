...
@section('container')
    ...
    @if ($tax->idPerihal == '1')
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 pt-4 px-4">
            <a id="backBtn" href="/dashboard/tax" class="btn btn-success"><i class="bi bi-arrow-left-square"></i>
                Kembali</a>
        ...
        <div id="contentToConvert" class="contentToConvert">
            <div class="page">
                <div class="header" id="header">
                    <img src="{{ asset('img/' . $tax->kop . '-kop-atas.png') }}" style="max-width: 100%; height: auto;">
                    <br><br>
                </div>
                        ...
                        <table width="545" style="font-weight:bold;">
                            <tr>
                                <td><img style="height:125px; weigth:125px;padding-left:15px;"
                                        src="{{ asset('img/qrcodes/' . $tax->qr) }}" alt="QR Code"></td>
                            </tr>
                        </table>
                    @else
                        <br><br><br><br>
                ...
                @if ($tax->kop !== null)
                    <div class="footer-page">
                        <img src="{{ asset('img/' . $tax->kop . '-bottom-kop.png') }}"
