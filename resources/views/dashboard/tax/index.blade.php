...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light text-center rounded p-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ url('/dashboard/tax/create') }}" class="btn btn-primary"><i class="bi bi-file-text-fill"></i> Tambah Surat</a>
        </div>
            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary" href="{{ url('/dashboard/tax/' . $item->id) }}"><i class="bi bi-info-square"></i></a>
                            <a class="btn btn-sm btn-warning" href="{{ url('/dashboard/tax/' . $item->id . '/edit') }}" @if($item->approve == "1") style="pointer-events:none; opacity:0.5;" @endif><i class="bi bi-pencil-square"></i></a>
                            <form action="{{ url('/dashboard/tax/' . $item->id) }}" method="post" class="d-inline delete-form">
                                @method('delete')
                                @csrf
