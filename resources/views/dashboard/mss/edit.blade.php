                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form method="post" action="/dashboard/mss">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="Ref. No:MSS/GEL/BA-{{ old('noSurat', $mss->noSurat) }}/{{ $romanMonth }}/2024"  class="form-control @error('noSurat') is-invalid @enderror" id="noSurat" name="noSurat"  required value="{{ old('noSurat') }}" disabled>
                            @error('noSurat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('pttuuan', $mss->pttujuan) }}" class="form-control @error('pttujuan') is-invalid @enderror" placeholder="Isi PT Tujuan..."
