        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4 mx-auto" style="width: 210mm;">
                    ...
                    <form method="post" action="/dashboard/finap/{{ $finap->id }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" class="form-control @error('noSurat') is-invalid @enderror" id="noSurat"
                                ...
                                value="{{ old('noSurat', $finap->noSurat) }}">
                            <br>
                            <input type="text" class="form-control" id="prefix" name="prefix" value="{{ old('noSurat', $finap->prefix) }}" readonly>
                            @error('noSurat')
                        ...
                        <div class="mb-3">
                            ...
                            <span style="font-weight:bold;">{{ old('department', $finap->departement) }}</span>
                            <input type="hidden" id="department" name="department"
                                class="form-control @error('department') is-invalid @enderror"
                                value="{{ old('department', $finap->department) }}" required>
                            <input type="hidden" id="idDepartment" name="idDepartment"
                                class="form-control @error('idDepartment') is-invalid @enderror"
                                value="{{ old('idDepartment', $finap->idDepartment) }}" required>
                            @error('department')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('vendor') is-invalid @enderror" id="vendor"
                                name="vendor" required value="{{ old('vendor', $finap->vendor) }}">
                            @error('vendor')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('dueDate') is-invalid @enderror" id="dueDate"
                                name="dueDate" required value="{{ old('dueDate', $finap->dueDate ?? '') }}">
                            @error('dueDate')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('coa') is-invalid @enderror" id="coa"
                                name="coa" value="{{ old('coa', $finap->coa) }}">
                            @error('coa')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('terbilang') is-invalid @enderror" readonly
                                id="terbilang" name="terbilang" required
                                value="{{ old('terbilang', $finap->terbilang) }}">
                            @error('terbilang')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ket') is-invalid @enderror" id="ket"
                                name="ket" required value="{{ old('ket', $finap->ket) }}">
                            @error('ket')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('a_nama') is-invalid @enderror"
                                id="a_nama" name="a_nama" required value="{{ old('a_nama', $finap->a_nama) }}">
                            @error('a_nama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('bank') is-invalid @enderror"
                                id="bank" name="bank" required value="{{ old('bank', $finap->bank) }}">
                            @error('bank')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('norek') is-invalid @enderror"
                                id="norek" name="norek" required value="{{ old('norek', $finap->norek) }}">
                            @error('norek')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                                ...
                                <tr>
                                    <td>
                                        <input type="date"
                                            ...
                                            name="tglSurat" required value="{{ old('tglSurat') }} "readonly>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('catatan') is-invalid @enderror" id="catatan" name="catatan" rows="3">{{ old('catatan', $finap->catatan) }}</textarea>
                            @error('catatan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
