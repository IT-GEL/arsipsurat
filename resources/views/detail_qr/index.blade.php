    ...
    <div class="container-fluid hero-header py-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-12">
                    <h1 class="display-4 mb-4 animated slideInDown">Surat {{ $detail->nosurat }} <br>Signed
                        by,</h1>
                    <div class="animated slideInDown">
                        ...
                        <p>Tanggal Approve:
                            {{ \Carbon\Carbon::parse($detail->approve_at)->format('d F Y') }}</p>
                        </div>

                    <button onclick="closeTab()"
                        class="btn btn-primary py-3 px-4 animated slideInDown">Close</button>
